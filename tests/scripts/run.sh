...
run_expect 0 "allow_agent_md"             ".claude/agents/researcher.md"
...
run_expect 0 "allow_multi_whitelisted"    ".claude/agents/researcher.md" "evals/tasks.jsonl"
...
run_expect 1 "deny_mixed_allow_block"     ".claude/agents/researcher.md" "src/index.ts"
