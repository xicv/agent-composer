...
| 2026-06-14 | Build 7 (Model migration: GLM `glm-5.1`→`glm-5.2` + codexReview gate→`gpt-5.5` (research-verified; `gpt-5.5-pro` corrected to `gpt-5.5`)) | `composer_code_cli` (codex) | n/a | n/a | n/a | n/a | n/a | 9 files | n/a | tsc+vitest+schema green, 9 files |
